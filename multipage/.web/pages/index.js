...
import { Box as RadixThemesBox, Link as RadixThemesLink, Separator as RadixThemesSeparator } from "@radix-ui/themes"
...
export default function Component() {
  ...
  <NextLink href={"/uno"} passHref={true}>
  {"uno"}
</NextLink>
</RadixThemesLink>
  <RadixThemesSeparator size={"4"}/>
  <RadixThemesLink asChild={true} css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })}>
  <NextLink href={"/dos"} passHref={true}>
  {"dos"}
</NextLink>
</RadixThemesLink>
  <RadixThemesSeparator size={"4"}/>
  <RadixThemesLink asChild={true} css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })}>
  <NextLink href={"/tres"} passHref={true}>
  {"tres"}
</NextLink>
</RadixThemesLink>
  <RadixThemesSeparator size={"4"}/>
  <RadixThemesLink asChild={true} css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })}>
  <NextLink href={"/tabla1"} passHref={true}>
  {"tabla 1"}
</NextLink>
</RadixThemesLink>
  <RadixThemesSeparator size={"4"}/>
  <RadixThemesLink asChild={true} css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })}>
  <NextLink href={"/tabla2"} passHref={true}>
  {"tabla 2"}
</NextLink>
</RadixThemesLink>
</RadixThemesBox>
