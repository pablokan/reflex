...
export function Text_aa84d6cc0e3efec45c7566e35d1d2f56 () {
  const reflex___state____state__mp___pages___tres____algo = useContext(StateContexts.reflex___state____state__mp___pages___tres____algo)



  return (
    <RadixThemesText as={"p"}>
  {reflex___state____state__mp___pages___tres____algo.a}
</RadixThemesText>
  )
}
...
export default function Component() {
  ...
  <Text_aa84d6cc0e3efec45c7566e35d1d2f56/>
  <NextHead>
  <title>
  {"Mp | Tres"}
</title>
